...
//    Calculation Values corresponding to spinner selected item
    ...
    TextView tVDataConv1, tVDataConv2;
    ...
    private void initViews() {
        spinnerDataConv1 = findViewById(R.id.spinnerDataConv1);
        spinnerDataConv2 = findViewById(R.id.spinnerDataConv2);
        tVDataConv1 = findViewById(R.id.tVDataConv1);
        tVDataConv2 = findViewById(R.id.tVDataConv2);
    }

    @Override
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        Spinner spinner = (Spinner) parent;
        if(spinner.getId() == R.id.spinnerDataConv1){
            selected1 = position;
            evaluate();
        }else if(spinner.getId() == R.id.spinnerDataConv2){
            selected2 = position;
            evaluate();
