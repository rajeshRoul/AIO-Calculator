        ...
        holder.cVCalcList.setOnClickListener(v -> {
            switch (position){
                case 0:{
                    ...
                    Intent intent = new Intent(context, CurrencyConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } case 3:{
                    ...
                    Intent intent = new Intent(context, EnergyConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } case 7: {
                    Intent intent = new Intent(context, MassConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } case 8:{
                    Intent intent = new Intent(context, TimeConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } case 9:{
                    Intent intent = new Intent(context, VolumeConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } case 10:{
                    Intent intent = new Intent(context, AreaConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } case 11:{
                    Intent intent = new Intent(context, LengthConvertorActivity.class);
                    context.startActivity(intent);
                    break;
                } default:{
